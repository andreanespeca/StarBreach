...
<gameSystem id="d284-e42e-1c51-a4fb" name="StarBreach" revision="1" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <publications>
    <publication id="9ed2-b94e-33e0-364e" name="StarBreach PDF V2.3"/>
  </publications>
  <costTypes>
    <costType id="9e37-50a0-9764-fda5" name="UC" defaultCostLimit="-1.0"/>
  </costTypes>
  <profileTypes>
    ...
    <profileType id="d89f-2134-4e54-a502" name="Weapon">
      <characteristicTypes>
        ...
        <characteristicType id="453a-bb38-6f29-78f1" name="Attach Roll Per Target"/>
    ...
    <profileType id="b156-a531-d7e5-2ffc" name="Grenade">
      <characteristicTypes>
        ...
        <characteristicType id="e0f2-cd4f-c267-fe03" name="Attach Roll Per Target"/>
  ...
  <sharedProfiles>
    ...
    <profile id="1da8-4bed-9ede-393b" name="Ruthless Nature 1" hidden="false" typeId="71cc-52da-8668-e6a7" typeName="Ability">
      <characteristics>
        <characteristic name="Ability" typeId="2243-ea94-8d78-7049">When a soldier with Ruthless Nature 1, and any friendly soldiers within 12” of the soldier with Ruthless Nature 1, are hit by Cover Fire, they do not execute Down Orders, but remain free to take orders normally.</characteristic>
      </characteristics>
    </profile>
